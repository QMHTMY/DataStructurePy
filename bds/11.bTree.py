...
class BTree:
    ...
    def __init__(self, m = 3):
        '''B树定义'''
        self.M = m                        #树的最小度数
        self.KEY_MAX = 2 * self.M - 1     #节点包含关键字的最大个数
        self.KEY_MIN = self.M - 1         #非根结点包含关键字的最小个数
        self.CHILD_MAX = self.KEY_MAX + 1 #子结点的最大个数
        self.CHILD_MIN = self.KEY_MIN + 1 #子结点的最小个数
        self.root: BTreeNode = None       #根结点
